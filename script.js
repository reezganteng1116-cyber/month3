...
function cekNilai() {
 ...
 function luasPersegi(sisi) {
    ...
    function hitung() {
      let nilaiSisi = document.getElementById("sisi").value;
      let hasil = luasPersegi(nilaiSisi);
      document.getElementById("hasil-persegi").textContent = 
        "Luas persegi = " + hasil;
    }

function aritmatikaSederhana(a, b, c, d, e) {
      return a + b - c * d / e;
    }

    function jumlah5Angka() {
      ...
      let hasilTigaAngka = aritmatikaSederhana(a, b, c, d, e);

      document.getElementById("hasil-penjumlahan").textContent =
        "Hasil dari " + a + " + " + b + " - " + c + " x " + d + " / " + e + " adalah = " + hasilTigaAngka;
    }
...
function konversiSuhu(celcius) {
  return (celcius * 9/5) + 32;
   ...
   function tampilkanCelcius() {
    let f = document.getElementById("celcius").value;
    let g = konversiSuhu(f);
    document.getElementById("derajat").innerText = g + " °F";
   }